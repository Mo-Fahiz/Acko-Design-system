...
| `--color-error-text` | Error message text | `var(--red-700)` | `var(--red-400)` |
...
| `--color-input-option-hover` | Option hover fill (Dropdown) | `var(--purple-50)` | `var(--grey-650)` |
...
| Property | Token | Value |
|----------|-------|-------|
| Border | `--color-input-border` | `var(--color-border-subtle)` (light) / `grey-450` (dark) |
