...
| Semantic Token | Primitive Value | Hex | Usage |
|---------------|----------------|-----|-------|
| `--color-text-strong` | `grey-800` | `#0A0A0A` | Headings, user-entered values, active/selected states |
| `--color-text-default` | `grey-700` | `#141414` | Labels, body text, system-provided UI text |
...
```json
{
  "color": {
    ...
    "text-strong": { "value": "{grey.800}", "type": "color" },
    "text-default": { "value": "{grey.700}", "type": "color" },
