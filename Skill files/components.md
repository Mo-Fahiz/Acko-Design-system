...
| Variant | Use Case | Light Fill | Light Border | Light Text | Dark Fill | Dark Border | Dark Text |
|---------|----------|-----------|-------------|-----------|----------|------------|----------|
| `primary` | Main CTA — one per view | `purple-600` | — | white | `purple-500` | — | white |
| `secondary` | Supporting actions with border | `purple-50` | `purple-300` | `purple-700` | `grey-650` | `purple-600` | `grey-50` |
| `inverted` | Neutral/soft actions | `grey-100` | — | `purple-700` | `grey-100` | — | `purple-700` |
| `ghost` | Inline/subtle actions | transparent | — | `purple-600` | transparent | — | `purple-500` |
| `link` | Text-style navigation actions | transparent | — | `blue-600` | transparent | — | `blue-500` |
| `danger` | Destructive (delete, remove) | `red-100` | — | `red-500` | `red-900` | — | `red-200` |
...
| Active | Same | Same | Same + `scale(0.97)` |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` | None |

**Secondary:**
| State | Background | Border | Text |
|-------|-----------|--------|------|
| Default | `--color-btn-secondary-bg` (purple-50) | `--color-btn-secondary-border` (purple-300) | `--color-btn-secondary-text` (purple-700) |
| Hover | Same + `brightness(0.96)` | Same | Same |
| Disabled | `--color-btn-disabled-bg` | None | `--color-btn-disabled-text` |

**Inverted:**
| State | Background | Text |
|-------|-----------|------|
| Default | `--color-btn-inverted-bg` (grey-100) | `--color-btn-inverted-text` (purple-700) |
| Hover | Same + `brightness(0.96)` | Same |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` |

**Ghost:**
| State | Background | Text |
|-------|-----------|------|
| Default | Transparent | `--color-btn-ghost-color` (purple-600) |
| Hover | `--color-btn-ghost-hover-bg` (purple-50) | Same |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` |

**Link:**
| State | Background | Text | Extra |
|-------|-----------|------|-------|
| Default | Transparent | `--color-btn-link-color` (blue-600) | No horizontal padding |
| Hover | Transparent | Same | `text-decoration: underline` |
| Disabled | Transparent | `--color-btn-disabled-text` | — |

**Danger:**
| State | Background | Text |
|-------|-----------|------|
| Default | `--color-btn-danger-bg` (red-100) | `--color-btn-danger-text` (red-500) |
| Hover | Same + `brightness(0.96)` | Same |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` |
...
|-------|-----------|------|--------|
| Default | `--color-primary` | `--color-on-primary` | `--shadow-btn-inner` |
| Hover | `--color-btn-primary-hover-bg` | Same | `--shadow-btn-inner` + `--shadow-btn-hover` |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` | None |

**Secondary:**
| State | Background | Border | Text |
|-------|-----------|--------|------|
| Default | grey-650 | purple-600 (1px inset) | grey-50 |
| Hover | Same + `brightness(1.1)` | Same | Same |
| Disabled | `--color-btn-disabled-bg` | None | `--color-btn-disabled-text` |

**Inverted:**
| State | Background | Text |
|-------|-----------|------|
| Default | grey-100 | purple-700 |
| Hover | Same + `brightness(0.9)` | Same |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` |

**Ghost:**
| State | Background | Text |
|-------|-----------|------|
| Default | Transparent | purple-500 |
| Hover | grey-600 | Same |
| Disabled | Transparent | `--color-btn-disabled-text` |
...
| State | Background | Text | Extra |
|-------|-----------|------|-------|
| Default | Transparent | blue-500 | No horizontal padding |
| Hover | Transparent | Same | `text-decoration: underline` |
| Disabled | Transparent | `--color-btn-disabled-text` | — |
...
| State | Background | Text |
|-------|-----------|------|
| Default | red-900 | red-200 |
| Hover | Same + `brightness(1.1)` | Same |
| Disabled | `--color-btn-disabled-bg` | `--color-btn-disabled-text` |
...
- **Secondary**: Glassmorphism with `backdrop-filter: blur(14px)`
...
|-------|-----------|------|---------------|
| Default | transparent | `--color-text-default` | `--radius-lg` (8px) |
| Hover | `--color-primary-subtle` | `--color-text-default` | `--radius-lg` |
| Selected | `--color-primary-subtle` | `--color-primary-hover` | `--radius-lg` |
| Focused (keyboard) | `--color-primary-subtle` | `--color-text-default` | `--radius-lg` |
...
| State | Background | Text | Extra |
|-------|-----------|------|-------|
| Default | `--color-surface` | `--color-text-default` | — |
| Hover | `--color-primary-subtle` | `--color-text-default` | — |
...
| Color | Background | Text | Dot | Outline |
|-------|-----------|------|-----|---------|
| `purple` | `--color-badge-purple-bg` | `--color-badge-purple-text` | `--color-badge-purple-text` | `--color-badge-purple-outline-color` |
| `green` | `--color-badge-green-bg` | `--color-badge-green-text` | `--color-badge-green-text` | `--color-badge-green-outline-color` |
| `blue` | `--color-badge-blue-bg` | `--color-badge-blue-text` | `--color-badge-blue-text` | `--color-badge-blue-outline-color` |
| `orange` | `--color-badge-orange-bg` | `--color-badge-orange-text` | `--color-badge-orange-text` | `--color-badge-orange-outline-color` |
| `pink` | `--color-badge-pink-bg` | `--color-badge-pink-text` | `--color-badge-pink-text` | `--color-badge-pink-outline-color` |
| `gray` | `--color-badge-gray-bg` | `--color-badge-gray-text` | `--color-badge-gray-text` | `--color-badge-gray-outline-color` |
...
| `current` | `--color-primary` | `--color-on-primary` | `--color-text-default` | `--color-border-subtle` |
| `completed` | `--color-success` | `--color-on-primary` (checkmark) | `--color-text-default` | `--color-success` |
...
- Min height: 3 lines of body text — `calc(3 * var(--font-body-md-line) + 2 * var(--space-3))` (~96px)
- Padding: `space-3` vertical, `space-5` horizontal
- Line height: `--font-body-md-line` (24px)
- Border radius: `--radius-3xl`
- Same states as TextInput (border, label, helper/error text)
- Custom scrollbar (4px, brand purple thumb) inherited from global styles
...
interface TypographyProps {
  ...
  color?: 'default' | 'muted' | 'disabled' | 'primary' | 'error' | 'success';
...
- Layout: `flex row`, `gap: var(--space-3)`, `padding: var(--space-2)`
...
|-------|-----------|----------------|-------|
| Unchecked | `--color-btn-disabled-bg` | `left: 2px` | — |
| Checked | `--color-primary` | `translateX(16px)` / `translateX(20px)` | `box-shadow: inset 0px 1px 2px 1px rgba(255,255,255,0.28)` |
| Focus | — | — | `box-shadow: 0 0 0 2px var(--color-primary-ring)` |
| Disabled (off) | `--grey-300` | `left: 2px` | `cursor: not-allowed` |
| Disabled (on) | `--color-primary` + `opacity: 0.5` | translated | `box-shadow: none`, `cursor: not-allowed` |

### Specifications

- Track: `border-radius: --radius-full`, `transition: background-color 200ms var(--ease-in-out-cubic)`
- Thumb: `background: var(--grey-white)` (always pure white), `box-shadow: --shadow-sm`, `transition: transform 200ms var(--ease-in-out-cubic)`, `border-radius: --radius-full`
- Checked track inset shadow: `inset 0px 1px 2px 1px rgba(255,255,255,0.28)` (matches primary button)
- Label: `--font-body-sm-size`, `--color-text-default`, `gap: var(--space-3)`
- Hidden native input uses visually-hidden pattern
- Dark theme unchecked track: `--color-btn-disabled-bg` (resolves to `grey-600`)
- Dark theme checked track shadow: `inset 0px 1px 2px 1px rgba(255,255,255,0.15)`
- Dark theme disabled off track: `--grey-500`
...
- Active: `background: --color-tab-pill-active-bg`, `color: --color-text-default`, `box-shadow: --shadow-sm`
- Hover: `color: --color-text-default`

**Enclosed:**
- Tab: `border: 1px solid var(--color-border-subtle)`, `border-bottom: none`, `border-radius: --radius-lg --radius-lg 0 0`
- Active: `background: --color-card-bg`, `border-bottom: 1px solid --color-card-bg`, `color: --color-text-default`
...
- Label: `--font-body-sm-size`, `weight: 500`, `--color-text-default`
...
- Global scrollbar: `scrollbar-width: thin`, `scrollbar-color: var(--color-primary-muted) transparent`
- Webkit scrollbar: `width/height: 4px`, thumb `--color-primary-muted`, thumb hover `--color-primary`, `border-radius: --radius-full`
